...
function HomePage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white overflow-hidden">
      {/* Navbar */}
      <Navbar />
      ...
      <div className="relative z-10 container mx-auto py-12">
        ...
        {/* <div className="my-16">
          <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">
            Featured Sellers
          </h2>
        </div> */}
        <List/> dfsd
